...
> ⚠️ **DICA IMPORTANTE:** a voz fica muito melhor no navegador Edge, parece muito mais humano. Você pode usar o nativo (do seu navegador) ou usar a sua [API Eleven LABS](https://elevenlabs.io/app/developers/api-keys).
